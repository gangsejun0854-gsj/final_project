...
function App() {
  ...
  return (
    <> 
    <UserProvider user={{ name: "강세준", grade: "우수" }}>    
    <section className="intro-transfer">
  <Header />
...
<div className='toolbar'>
  ...
  <button className='btn-ghost' onClick={() => setShowAmount(!showAmount)}>
  ...
  <Panel title="이체">
    ...
    <div className="total">
      <p> 총 자산 </p>
      <p className="total-amount">{formatWon(totalBalance)}</p>
    </div>
    {/* 사용 */}
